...
# Load model, scaler, kmeans, dan PCA
model = joblib.load('model_logreg.pkl')
scaler = joblib.load('scaler.pkl')
kmeans = joblib.load('kmeans_final.pkl')  # Sesuai nama file yang disimpan
# Perlu load PCA juga karena pipeline menggunakan PCA
try:
    pca = joblib.load('pca.pkl')
    use_pca = True
except:
    st.warning("File pca.pkl tidak ditemukan. Pastikan PCA sudah disimpan dari notebook.")
    use_pca = False
...
if st.button("Prediksi Loan Status") and use_pca:
    # Scaling
